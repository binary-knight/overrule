...
export function rulesFor(run) { return RULES.replace('{{TOOLS}}', run?.workspace ? TOOLS_WORKSPACE : TOOLS_NONE); }
...
export function thread(run, { keep = KEEP_FULL_TURNS } = {}) {
  const done = committed(run);
