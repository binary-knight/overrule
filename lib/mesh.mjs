...
export function validateRun(input, providers) {
  ...
  return { prompt, participants, drafterId, cycles, maxTokens, timeoutSeconds, maxRevisions, ...limits, workspace: input.workspace || null };
}
...
export class Mesh {
  ...
  applySettings(run, { workspace, cycles, maxRevisions } = {}) {
    const changed = [];
    if (workspace) {
